...
- **Coding Environment:** `F:\VS Code\WORKS\DSA-Mastery` (Git repository). Akshar codes everything locally inside VS Code.
- **Tracking Hub:** Obsidian Vault (`F:\VS Code\WORKS\DSA-Mastery\Obsidian Vault` or similar). You MUST read `/media/aksharsrijan/Storage/Obsidian Vault/DSA/00_Dashboard/Index.md` at the start of any session to know what day it is.
- **The Loop:** 
...
1. `/media/aksharsrijan/Storage/Obsidian Vault/DSA/01_Phase_0_Core_Java/Cheat Sheet.md` (To know their exact syntax weaknesses).
